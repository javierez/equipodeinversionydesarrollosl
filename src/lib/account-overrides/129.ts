...
export const ACCOUNT_129_SOCIAL_LINKS: SocialLink[] = [
  {
    ...
    previewImage:
      "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/social/instagram.png",
  },
  {
    platform: "tiktok",
    url: "https://tiktok.com/",
    previewImage:
      "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/social/tiktok.png",
  },
  {
    platform: "youtube",
    url: "https://youtube.com/",
    previewImage:
      "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/social/youtube.png",
  },
];
...
export const ACCOUNT_129_SERVICIOS = {
  hero: {
    videoUrl:
      "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/servicios/hero-video.mp4",
  ...
  services: [
    {
      ...
      icon: "handshake",
      image:
        "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/servicios/venta-compra.jpg",
    },
    {
      title: "Alquileres",
      description:
      ...
      icon: "key",
      image:
        "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/servicios/alquileres.jpg",
    },
    {
      ...
      icon: "calculator",
      image:
        "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/servicios/valoraciones.jpg",
    },
    {
      ...
      icon: "hammer",
      image:
        "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/servicios/obras.jpg",
    },
    {
      ...
      icon: "ruler",
      image:
        "https://vesta-crm-prod.s3.us-east-1.amazonaws.com/accounts/129/website/servicios/topografia.jpg",
    },
  ],
} as const;
